...
export default async function DashboardPage() {
  ...
  const [streak, weeklyCalories, dailyCalories, consistencyTrend, workoutDates, volumeProgress, profile] =
    await Promise.all([
  ...
  return (
    <div className="flex flex-col gap-6 animate-fade-in">
      ...
      <CalendarWidget workouts={workoutDates} gender={profile.gender} />
